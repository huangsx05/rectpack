...
# config_ocod = f'../config/config_{production_line}_ocod_1.yaml'
# config_ocmd = f'../config/config_{production_line}_ocmd_2.yaml'
# config_mcmd_w_sep = f'../config/config_{production_line}_mcmd_w_sep_3.yaml'
# config_mcmd_wo_sep = f'../config/config_{production_line}_mcmd_wo_sep_4.yaml'

# COMMAND ----------

ocod_runner_path = "1_ocod_runner"
ocmd_runner_path = "2_ocmd_runner"
mcmd_w_sep_runner_path = "3_mcmd_w_sep_runner"
mcmd_wo_sep_runner_path = "4_mcmd_wo_sep_runner"
...
if params_dict['batching_type']=='1_OCOD':
  #run(path: String,  timeout_seconds: int, arguments: Map): String
  dbutils.notebook.run(ocod_runner_path, 600, {input_file:params_dict['input_file']})
